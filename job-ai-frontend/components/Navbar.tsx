...
import { Menu, X, LayoutDashboard, Upload, FileText, Briefcase, ClipboardList, Moon, Sun } from "lucide-react";
        ...
        <div className="flex h-16 items-center justify-between">
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        active
                          ? "text-white bg-gradient-to-br from-violet-600 to-fuchsia-600 shadow-sm shadow-fuchsia-600/25"
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="flex size-9 items-center justify-center rounded-lg text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-white"
            >
            ...
            {user ? (
              ...
              <>
                ...
                <Link
                  href="/register"
                  className="inline-flex items-center rounded-lg bg-gradient-to-br from-violet-600 to-fuchsia-600 px-4 py-2 text-sm font-semibold text-white btn-glow ring-1 ring-white/20 transition-transform hover:scale-[1.03] active:scale-[0.98]"
                >
                  Get started
                </Link>
              </>
