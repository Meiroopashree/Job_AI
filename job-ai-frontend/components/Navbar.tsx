                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        active
                          ? "text-white bg-gradient-to-br from-teal-600 to-emerald-600 shadow-sm shadow-emerald-600/25"
          ...
          <div className="flex items-center gap-1.5">
            ...
            {user ? (
              ...
              <>
                ...
                <Link
                  href="/register"
                  className="inline-flex items-center rounded-lg bg-gradient-to-br from-teal-600 to-emerald-600 px-4 py-2 text-sm font-semibold text-white btn-glow ring-1 ring-white/20 transition-transform hover:scale-[1.03] active:scale-[0.98]"
                >
                  Get started
                </Link>
              </>
