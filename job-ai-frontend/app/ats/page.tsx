  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8 animate-in">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">ATS Resume Checker</h1>
        <p className="mt-1 text-slate-500 dark:text-slate-400">
          Check how ATS-friendly your resume is and get an optimized version
        </p>
      </div>
