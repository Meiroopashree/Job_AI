    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8 animate-in">
      <div className="mb-8">
        ...
        <PageHeader
          ...
          subtitle={
            totalJobs > 0
              ? `${totalJobs} jobs ranked by how well they fit your resume`
              : "AI-matched jobs based on your profile"
          }
          actions={
            <label className="inline-flex cursor-pointer items-center gap-2 rounded-xl border border-white/20 bg-white/10 px-3.5 py-2.5 text-sm font-medium text-white backdrop-blur transition-colors hover:bg-white/15">
              <input
                type="checkbox"
                checked={onlyRecent}
