    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 animate-in">
      <div className="mb-8 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Link
            href="/jobs"
            className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-blue-200 bg-white/80 px-4 py-2.5 text-sm font-semibold text-blue-700 shadow-sm backdrop-blur transition-colors hover:bg-blue-50 dark:border-blue-900 dark:bg-slate-900/70 dark:text-blue-400 dark:hover:bg-blue-950/30"
          >
